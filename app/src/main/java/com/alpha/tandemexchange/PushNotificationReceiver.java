...
/**
 * Used by Layer to send push notifications
 */
...
public class PushNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        if (intent.getAction().equals(ACTION_PUSH)) {
            ...
            Util.waitForContent(MainActivity.getLayerClient().connect(), messageId,
    ...
    public static class Notifications {
        ...
        private void update(Context context, Conversation conversation, Message message) {
            ...
            String conversationTitle = Util.getConversationTitle(MainActivity.getLayerClient(), MainActivity.getParticipantProvider(), conversation);
        ...
        private long getMaxPosition(Uri conversationId) {
            LayerClient layerClient = MainActivity.getLayerClient();
